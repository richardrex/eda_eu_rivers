...
saveRDS(cz_runoff_day, '~/R/Projects/eda_eu_rivers/data/cz_runoff.rds')
saveRDS(de_runoff_day, '~/R/Projects/eda_eu_rivers/data/de_runoff.rds')
saveRDS(fr_runoff_day, '~/R/Projects/eda_eu_rivers/data/fr_runoff.rds')
saveRDS(no_runoff_day, '~/R/Projects/eda_eu_rivers/data/no_runoff.rds')
saveRDS(ru_runoff_day, '~/R/Projects/eda_eu_rivers/data/ru_runoff.rds')
saveRDS(se_runoff_day, '~/R/Projects/eda_eu_rivers/data/se_runoff.rds')
saveRDS(stations_coords_sf_cz, '~/R/Projects/eda_eu_rivers/data/cz_cord.rds')
saveRDS(stations_coords_sf_de, '~/R/Projects/eda_eu_rivers/data/de_cord.rds')
saveRDS(stations_coords_sf_fr, '~/R/Projects/eda_eu_rivers/data/fr_cord.rds')
saveRDS(stations_coords_sf_no, '~/R/Projects/eda_eu_rivers/data/no_cord.rds')
saveRDS(stations_coords_sf_ru, '~/R/Projects/eda_eu_rivers/data/ru_cord.rds')
saveRDS(stations_coords_sf_se, '~/R/Projects/eda_eu_rivers/data/se_cord.rds')
saveRDS(runoff_station_day, '~/R/Projects/eda_eu_rivers/data/runoff_station_raw.rds')
